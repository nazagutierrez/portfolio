export const svgRender = ( type ) => {
    return (
      <>
        ...
        {type === "link" && (
          <svg className="text-black-main text-xl ms-2 inline-block" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
